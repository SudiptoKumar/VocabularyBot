...
_PLACEHOLDER_PHRASES = {
    "meaning enrichment unavailable.",
    "meaning enrichment unavailable",
...
Use the supplied Bangla meaning as the VERIFIED sense anchor. It has already passed semantic verification. Do not invent an unrelated sense.
...
def _sanitize(item: dict, word: WordEntry) -> EnrichedWord:
    ...
    for key in (
        ...
        setattr(base, key, _usable_text(item.get(key, "")))
