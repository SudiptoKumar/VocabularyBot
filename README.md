...
### V1.0.4
- Photo card: no IPA; Type/CEFR retained; Bangla meaning restored with Hind Siliguri; LISTEN remains text-only; no pagination.
- Rich example: Bangla translation appears directly beneath the English sentence without the extra “বাংলা” label.
