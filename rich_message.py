...
def build_rich_message(word: WordEntry, enriched: EnrichedWord, *, card_media: str | None = None, audio_media: str | None = None, card_attach: str | None = None, audio_attach: str | None = None) -> dict[str, Any]:
